...
<div class="breadcrumb">
    ...
    <span class="breadcrumb-sep">/</span>
    <span class="breadcrumb-current">Tambah Service</span>
</div>
...
<div class="form-card" style="margin: 0 auto;">
    <div class="form-card-header">
        ...
        <div>
            <h2>Buat Layanan Digital Baru</h2>
            <p>Tambahkan paket layanan baru untuk ditawarkan kepada pelanggan</p>
        </div>
    </div>
        ...
        <div class="form-card-body">
            ...
            <div class="form-group">
                ...
                <input type="text" id="name" name="name" 
                       ...
                       placeholder="Contoh: VPS Business, Shared Hosting Pro..." value="{{ old('name') }}" required>
                @error('name')
            ...
            <div class="form-group">
                ...
                <input type="number" id="price" name="price" min="0"
                       ...
                       placeholder="Masukkan nominal harga bulanan..." value="{{ old('price') }}" required>
                @error('price')
                    <div class="form-error-msg">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <textarea id="description" name="description" 
                          ...
                          placeholder="Masukkan detail spesifikasi atau info tambahan layanan...">{{ old('description') }}</textarea>
                @error('description')
                    <div class="form-error-msg">{{ $message }}</div>
                @enderror
            </div>
